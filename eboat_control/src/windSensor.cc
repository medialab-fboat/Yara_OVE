...
#include "../include/windSensor.hh"

using namespace gazebo;

GZ_REGISTER_MODEL_PLUGIN(WindSensorPlugin)

//////////////////////////////////////////////////////////////////////
WindSensorPlugin::WindSensorPlugin(): freq(1.0)
{
    /**
...
void WindSensorPlugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
    ...
    if (_sdf->HasElement("link_name"))
    {
        ...
        this->link = _model->GetLink("biruta_link");
    ...
    topic_name.append("/sensors/wind_sensor");
...
/////////////////////////////////////////////////
void WindSensorPlugin::Init()
{
    this->updateConnection = event::Events::ConnectWorldUpdateBegin(boost::bind(&WindSensorPlugin::OnUpdate, this));
}

//////////////////////////////////////////////////////////////////////
void WindSensorPlugin::OnUpdate()
{
    ...
    if ((Q >= 0.0) & (Q <= 0.00001))
    {
        ...
        ignition::math::Vector3d apWind        = this->link->WorldWindLinearVel() - this->link->WorldLinearVel();
        ...
        float windAngle = this->link->RelativePose().Rot().Yaw() * this->r2d;
        if (windAngle < 0.0)
        {
            windAngle += 360;
        }
