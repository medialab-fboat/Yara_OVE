...
def regatta(pause, unpause, boomAng_pub, rudderAng_pub, propVel_pub, wind_pub, sep_dist = 100, wind_speed = 10, wind_angle = 0):
    ...
    # --> RL agent
    model = PPO.load("/home/araujo/eboat_ws/src/eboat_gz_1/models/PPO/ensign_five/eboat_ocean_50")
    # model = PPO.load("/home/araujo/eboat_ws/src/eboat_gz_1/models/PPO/model1_13042023_10_15_19/eboat_ocean_50")
